(function ($) {
    ...
    ///////////////////////////////////////////////////// Your
    var venueAddress = "Department of Mathematics, Anna University, Chennai";
    /////////////////////////////////////////////////// Adress
    ...
    var fn = {
        ...
        EventRedirect: function () {
            $("#event-redirect").click(function () {
                var redirect_url = $("select#ticket").find(":selected").val();
                if (redirect_url) {
    ...
    $(document).ready(function () {
        ...
        $("form.gothereb ul.options li").click(function() {
          $("a.gothereb").attr("href", $(this).data("raw-value"));
        });
    });

    //$("select#website").change(function() {
    //var link = $(this).parent().find("a.gothereb");
